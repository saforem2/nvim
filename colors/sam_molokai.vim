...
hi Special         guifg=#448aff guibg=bg,italic      gui=bold
...
" hi StatusLine      guifg=#f8f8f8 guibg=fg
" hi StatusLineNC    guifg=#3e4b59 "guibg=#080808
...
hi CursorLineNr     guifg=#00CCFF   gui=bold
...
hi BufferCurrent guifg=#f0f0f0 guibg=#1c1c1c gui=bold,undercurl
hi BufferCurrentIndex guifg=#f0f0f0 guibg=#1c1c1c
hi BufferCurrentMod guifg=#FFFF00 gui=bold
hi BufferCurrentSign guifg=#dfdfdf guibg=#1c1c1c

hi BufferVisible guifg=#505050 guibg=#252525 gui=italic
hi BufferVisibleSign  guifg=#505050 guibg=#252525 gui=bold
hi BufferVisibleIndex guifg=#404040 guibg=#252525 gui=bold
hi BufferVisibleMod guifg=#404040 guibg=#252525

hi LineNr guifg=#303030
hi BufferInactive guifg=#505050 guibg=#303030
hi BufferInactiveSign guifg=#404040 guibg=#303030
hi BufferInactiveIndex guifg=#353535 guibg=#303030
hi BufferInactiveMod guifg=#353535 guibg=#303030

hi TabLine         guifg=#303030 guibg=#202020
hi TabLineFill     guifg=#252525 guibg=#202020

" hi lualine_c_normal guibg=#353535
" hi lualine_x_normal guibg=#353535
" hi lualine_y_normal guibg=#353535

hi link pythonfString pythonDocstring
hi link pythonfDocstring pythonDocstring
hi link pythonStringModifier PreProc

hi DiagnosticHint guifg=#FFFF00

hi TSField guifg=#65D8EE
hi TSConstructor guifg=#03CEFF
" #00e676
" hi TSMethod guifg=#b2ff59 gui=bold 
hi TSMethod guifg=#63ff5b 

hi TSKeyword guifg=#40c057 gui=BOLD
" hi TSKeywordFunction guifg=#B1FF85 gui=bold
hi TSKeywordFunction guifg=#FF79FF gui=bold
hi TSPunctBracket guifg=#9e9e9e
"#A1C3D1
...
" hi pythonTSField guifg=#ea80fc
hi pythonTSField guifg=#40c4ff
hi pythonTSConstructor guifg=#448AFF
hi pythonTSType guifg=#ff79ff 
hi pythonTSVariableBuiltin guifg=#bcbcbc
hi pythonTSVariable guifg=clear
hi pythonTSBoolean guifg=#ff4081
hi TSParameter guifg=#97F5D3
hi pythonTSType guifg=#16DB93
hi pythonTSVariableBuiltin guifg=#8b949e

" -- vim.cmd("hi semshiGlobal guifg=#ffaf00
" ---------------------------------------------- semshi config
"  ----------------------------------- defaults
hi semshiGlobal guifg=#2CC36E
hi semshiLocal guifg=#ff875f
hi semshiGlobal guifg=#b47cff
hi semshiImported guifg=#69f0ae cterm=bold gui=bold
...
hi semshiSelected guifg=#FFCCCC guibg=#ff5252
hi semshiErrorSign guifg=#FFCCCC guibg=#FF5252
hi semshiErrorChar guifg=#FFCCCC guibg=#FF5252
" sign define semshiError text=E> texthl=semshiErrorSign
" }}}

"  ----------------------------------- custom {{{
hi semshiImported guifg=#b1ff85
hi semshiSelf guifg=#9d9d9d gui=NONE
hi semshiGlobal guifg=#63ff51
" #B1FF85  #b2ff59
" hi semshiAttribute guifg=#d1bcf9 gui=NONE
" hi semshiAttribute guifg=#FF03CE gui=NONE
hi semshiAttribute guifg=#AE81FF gui=NONE
hi semshiImported guifg=#d1bcf9
" }}}
"
" hi DevIconPy guifg=#40c057
hi DevIconPy guifg=#40c057
"#00E676
...
" highlight semshiAttribute guibg=NONE guifg=#d1bcf9
...
hi lualine_b_normal guibg=#FFF
hi lualine_c_normal guibg=#FFF
...
hi rainbowcol1  guifg=#00E676  " #EC407A
" hi rainbowcol3  guifg=#AB47BC
hi rainbowcol2  guifg=#F92672  " #7E57C2
" hi rainbowcol5  guifg=#5C6BC0
hi rainbowcol3  guifg=#42A5F5
" hi rainbowcol7  guifg=#29B6F6
" hi rainbowcol4  guifg=#26C6DA
hi rainbowcol4  guifg=#26A69A
" hi rainbowcol5 guifg=#66BB6A
hi rainbowcol5 guifg=#9CCC65
" hi rainbowcol6 guifg=#D4E157
hi rainbowcol6 guifg=#FFEE58
" hi rainbowcol6 guifg=#FFCA28
hi rainbowcol7 guifg=#FFA726
hi rainbowcol8 guifg=#ef5350


" #FF4081
hi markdownTSTitle guifg=#FF4081 guibg=#1c1c1c gui=bold
hi markdownTSLiteral guifg=#B2FF59 guibg=#202020
" #bff525
"
hi @variable guifg=#E1F5FE
hi @field guifg=#d1bcf9  " #FF80AB
hi @number guifg=#69F0AE
hi @variable guifg=#B7BFCD
hi @variable.builtin guifg=#F39CF4 gui=bold


hi BufferLineBackground guibg=#1d1d1d
hi BufferLineCloseButton guibg=#1d1d1d
hi BufferLineSeparator guibg=#1d1d1d
hi BufferCurrent gui=bold,undercurl guifg=#1c1c1c guibg=#f0f0f0
hi BufferCurrentIndex guifg=#f0f0f0 guibg=#1c1c1c
hi BufferCurrentMod gui=bold guifg=#ffff00
hi BufferCurrentSign guifg=#dfdfdf guibg=#1c1c1c
" hi BufferCurrentTarget
hi BufferVisible gui=bold guifg=#505050 guibg=#252525
hi BufferVisibleIndex gui=bold guifg=#404040 guibg=#252525
hi BufferVisibleMod guifg=#404040 guibg=#252525
hi BufferVisibleSign gui=bold guifg=#505050 guibg=#252525
" hi BufferVisibleTarget
hi BufferInactive guifg=#505050 guibg=#1d1d1d
hi BufferInactiveIndex guifg=#353535 guibg=#1d1d1d
hi BufferInactiveMod guifg=#353535 guibg=#1d1d1d
hi BufferInactiveSign guifg=#404040 guibg=#1d1d1d
hi BufferLineFill guibg=#1d1d1d
" hi BufferInactiveTarget
" hi BufferTabpage
" hi BufferTabpages
hi BufferLineIndicatorSelected guifg=#66d9ef guibg=#1c1c1c
hi IndentBlanklineContextChar cterm=nocombine gui=nocombine guifg=#ffff00
hi IndentBlanklineContextStart cterm=underline gui=underline guisp=#ffff00
hi IndentBlanklineChar cterm=nocombine ctermfg=12 gui=nocombine guifg=#465457
hi BufferLineDevIconSh guifg=#666666 guibg=#1d1d1d
hi BufferLineDevIconVim guibg=#1d1d1d
hi BufferLineDevIconVimInactive guifg=#248546 guibg=#1d1d1d

hi BufferLineBufferSelected cterm=bold,italic gui=bold,italic guifg=#ffffff guibg=#1c1c1c
hi BufferLineHintSelected cterm=bold,italic gui=bold,italic guifg=#ffff00 guibg=#1c1c1c guisp=#ffff00
hi BufferLineBuffer guifg=#404040 guibg=#1d1d1d
hi BufferLineInfoDiagnosticSelected cterm=bold,italic gui=bold,italic guifg=#81a2ac guibg=#1c1c1c guisp=#81a2ac
hi BufferLineHintDiagnostic guifg=#303030 guibg=#1d1d1d guisp=#bfbf00
hi BufferLineCloseButtonSelected guifg=#ffffff guibg=#1c1c1c
hi BufferLineError guifg=#404040 guibg=#1d1d1d guisp=#ff0000
hi BufferLineHint guifg=#404040 guibg=#1d1d1d guisp=#ffff00
hi BufferLineOffsetSeparator guifg=#303030 guibg=#0f0f0f
hi BufferLinePickVisible cterm=bold,italic gui=bold,italic guifg=#ff0000 guibg=#191919
hi BufferLinePickSelected cterm=bold,italic gui=bold,italic guifg=#ff0000 guibg=#1c1c1c
hi BufferLineModified guifg=#ffff00 guibg=#1d1d1d
hi BufferLineTabSeparatorSelected guifg=#0f0f0f guibg=#1c1c1c
hi BufferLineTabSeparator guifg=#0f0f0f guibg=#1d1d1d
hi BufferLineSeparatorVisible guifg=#0f0f0f guibg=#191919
hi BufferLineSeparatorSelected guifg=#0f0f0f guibg=#1c1c1c
hi BufferLineDuplicate cterm=italic gui=italic guifg=#3c3c3c guibg=#1d1d1d
hi BufferLineDuplicateVisible cterm=italic gui=italic guifg=#3c3c3c guibg=#191919
hi BufferLineDuplicateSelected cterm=italic gui=italic guifg=#3c3c3c guibg=#1c1c1c
hi BufferLineModifiedSelected guifg=#ffff00 guibg=#1c1c1c
hi BufferLineModifiedVisible guifg=#ffff00 guibg=#191919
hi BufferLineErrorDiagnosticSelected cterm=bold,italic gui=bold,italic guifg=#bf0000 guibg=#1c1c1c guisp=#bf0000
hi BufferLineErrorDiagnosticVisible guifg=#303030 guibg=#191919
hi BufferLineTab  guifg=#404040 guibg=#1d1d1d
hi BufferLineErrorSelected cterm=bold,italic gui=bold,italic guifg=#ff0000 guibg=#1c1c1c guisp=#ff0000
hi BufferLineErrorVisible guifg=#404040 guibg=#191919
hi BufferLineWarningDiagnosticSelected cterm=bold,italic gui=bold,italic guifg=#bf7b00 guibg=#1c1c1c guisp=#bf7b00
hi BufferLineWarningDiagnosticVisible guifg=#303030 guibg=#191919
hi BufferLineWarningDiagnostic guifg=#303030 guibg=#1d1d1d guisp=#bf7b00
hi BufferLineWarningSelected cterm=bold,italic gui=bold,italic guifg=#ffa500 guibg=#1c1c1c guisp=#ffa500
hi BufferLineWarningVisible guifg=#404040 guibg=#191919
hi BufferLineDiagnostic guifg=#303030 guibg=#1d1d1d
hi BufferLineInfoDiagnosticVisible guifg=#303030 guibg=#191919
hi BufferLineInfoDiagnostic guifg=#303030 guibg=#1d1d1d guisp=#81a2ac
hi BufferLineInfoSelected cterm=bold,italic gui=bold,italic guifg=#add8e6 guibg=#1c1c1c guisp=#add8e6
hi BufferLineInfoVisible guifg=#404040 guibg=#191919
hi BufferLineHintDiagnosticSelected cterm=bold,italic gui=bold,italic guifg=#bfbf00 guibg=#1c1c1c guisp=#bfbf00
hi BufferLineHintDiagnosticVisible guifg=#303030 guibg=#191919
hi BufferLinePick cterm=bold,italic gui=bold,italic guifg=#ff0000 guibg=#1d1d1d
hi BufferLineInfo guifg=#404040 guibg=#1d1d1d guisp=#add8e6
hi BufferLineHintVisible guifg=#404040 guibg=#191919
hi BufferLineDiagnosticSelected cterm=bold,italic gui=bold,italic guifg=#bfbfbf guibg=#1c1c1c
hi BufferLineDiagnosticVisible guifg=#303030 guibg=#191919
hi BufferLineNumbersVisible guifg=#404040 guibg=#191919
hi BufferLineNumbersSelected cterm=bold,italic gui=bold,italic guifg=#ffffff guibg=#1c1c1c
hi BufferLineBufferVisible guifg=#404040 guibg=#1d1d1d
hi BufferLineCloseButtonVisible guifg=#404040 guibg=#191919
hi BufferLineWarning guifg=#404040 guibg=#1d1d1d guisp=#ffa500
hi BufferLineTabClose guifg=#404040 guibg=#1d1d1d
hi BufferLineTabSelected guifg=#66d9ef guibg=#1c1c1c
hi BufferLineGroupLabel guifg=#0f0f0f guibg=#404040
hi BufferLineGroupSeparator guifg=#404040 guibg=#0f0f0f
hi BufferLineErrorDiagnostic guifg=#303030 guibg=#1d1d1d guisp=#bf0000
hi BufferLineIndicatorVisible guifg=#191919 guibg=#191919
hi BufferLineNumbers guifg=#404040 guibg=#1d1d1d
hi BufferLineDevIconSh guifg=#666666
